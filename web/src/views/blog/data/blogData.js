// 严选 12 篇硬核开发文章 - 包含完整 Content 以供详情页展示
export const categories = [
    { value: 'frontend', label: '前端开发' },
    { value: 'backend', label: '后端架构' },
    { value: 'devops', label: '服务器与运维' },
...
export const articles = [
    {
        ...
        excerpt: '探索 Vue 3 Composition API 的核心概念，以及它如何改变我们构建大型应用的方式。',
        date: '2023-10-15',
        category: 'frontend',
        tags: ['Vue.js', 'JS'],
    ...
    {
        id: 2,
        title: 'WebGL 与 Three.js 入门指南',
        excerpt: '开启 3D 网页开发之旅。本文将带你了解 WebGL 的基础知识，并使用 Three.js 创建你的第一个 3D 场景。',
        date: '2023-09-22',
        category: 'design',
        tags: ['Three.js', '3D'],
    ...
    {
        id: 3,
        title: 'Nginx 高级反向代理配置',
        excerpt: '深入理解 Nginx 核心功能。如何配置负载均衡策略？动静分离又是如何提升性能的？',
        date: '2023-11-05',
        category: 'devops',
        tags: ['Nginx', '运维'],
    ...
    },
    {
        id: 4,
        title: 'Linux 常用命令大汇总',
        excerpt: '针对开发者的 Linux 命令速查手册。包含文件操作、进程管理、网络监控等高频命令详解。',
        date: '2023-11-01',
        category: 'devops',
        tags: ['Linux', 'Shell'],
    ...
    {
        id: 5,
        title: '现代 CSS 布局技巧：Grid',
        excerpt: '重新审视 CSS 布局系统。如何灵活运用 Grid 创建响应式、复杂的网页布局？',
        date: '2023-08-10',
        category: 'frontend',
        tags: ['CSS', 'Grid'],
    ...
    {
        id: 6,
        title: 'Node.js 内存管理与优化',
        excerpt: '基于 Node.js 构建高并发服务。探讨事件循环、内存堆栈分配以及内存泄漏排查技巧。',
        date: '2023-07-05',
        category: 'backend',
        tags: ['Node.js', '后端'],
    ...
    },
    {
        ...
        excerpt: '从 Dockerfile 编写到多容器编排。掌握容器化技术，彻底解决开发环境一致性难题。',
        date: '2023-05-30',
        category: 'backend',
        tags: ['Docker', '容器'],
    ...
    {
        id: 8,
        title: 'Nginx CORS 跨域方案全解',
        excerpt: '彻底终结跨域噩梦。在 Nginx 层面实现精细化的请求分层管理。',
        date: '2023-11-28',
        category: 'devops',
        tags: ['CORS', '网络'],
    ...
    {
        id: 9,
        title: 'Shell 脚本自动化备份指南',
        excerpt: '运维自动化的第一步。编写可维护的 Bash 脚本实现数据库定时异地备份。',
        date: '2023-12-05',
        category: 'devops',
        tags: ['Shell', '自动化'],
    ...
    },
    {
        id: 10,
        title: 'Go 语言并发模式与实践',
        excerpt: '深度解析 Goroutine。如何利用 Channel 构建能够抗住百万 QPS 的高并发后端。',
        date: '2023-12-10',
        category: 'backend',
        tags: ['Go', '并发'],
    ...
    },
    {
        ...
        excerpt: '探索 TS 的类型系统上限。如何利用映射类型和条件类型构建强壮的库接口。',
        date: '2023-12-15',
        category: 'frontend',
        tags: ['TS', '进阶'],
    ...
    {
        id: 12,
        title: 'Redis 分布式锁的核心原理',
        excerpt: '在高并发场景下如何保证一致性？对比 Redlock 算法以及常见的锁实现方案。',
        date: '2023-12-20',
        category: 'backend',
        tags: ['Redis', '锁'],
